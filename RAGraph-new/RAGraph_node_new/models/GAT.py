# 这段代码是对 Graph Attention Network (GAT) 的 PyTorch 实现，
# 位于 ragraph_node/models/GAT.py 文件中。
# 它是 RAGRAPH 中的一个基础图神经网络模块（backbone encoder），
# 可作为 toy graph 或 query graph 的编码器
import torch
