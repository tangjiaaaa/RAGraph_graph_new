...
def process_tu(data, class_num, node_class, max_ring=6):
    ...
    if all_ring_rows:
        ...
        two_cell_cochain = Cochain(dim=2, boundary_index=None)

    complex_obj = Complex(v_cochain, e_cochain, two_cell_cochain)
    print("type two_cell_cochain:", type(two_cell_cochain))
    print("complex_obj type:", type(complex_obj))
    print("complex_obj.two_cells type:", type(complex_obj.two_cells))
    print("complex_obj.two_cells.boundary_index:",
          type(complex_obj.two_cells.boundary_index) if hasattr(complex_obj.two_cells, 'boundary_index') else None)
