...
def parse_args():
    ...
    # parser.add_argument('--data_path', type=str, default="dataset/amazon", help='where to load data')
    # parser.add_argument('--data_path', type=str, default="dataset/taobao", help='where to load data')
    parser.add_argument('--data_path', type=str, default="dataset/koubei", help='where to load data')
    ...
    # parser.add_argument('--pre_model_path', type=str, default='pretrained_weights/GraphPro_Amazon_pretrained.pt')
    # parser.add_argument('--pre_model_path', type=str, default='pretrained_weights/GraphPro_Taobao_pretrained.pt')
    parser.add_argument('--pre_model_path', type=str, default='pretrained_weights/GraphPro_Koubei_pretrained.pt')
